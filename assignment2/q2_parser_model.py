...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        self.h=tf.nn.relu(tf.matmul(x,self.W)+self.b1)
        self.h_drop=tf.nn.dropout(self.h,1-self.dropout_placeholder)
    ...
    def add_loss_op(self, pred):
        ...
        ### YOUR CODE HERE
        ### END YOUR CODE
        loss_t=tf.nn.softmax_cross_entropy_with_logits(labels=self.labels_placeholder,logits=self.add_prediction_op())
