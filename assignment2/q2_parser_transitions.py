...
def minibatch_parse(sentences, model, batch_size):
    ...
    ### YOUR CODE HERE
    ### END YOUR CODE
    pps=[PartialParse(sentence) for sentence in sentences]
    unfinished=pps
    while len(unfinished)>0:
        minibatch=unfinished[0:batch_size]
        ...
        unfinished = unfinished[batch_size:]
    dependencies=[pp.dependencies for pp in pps]
    return dependencies
