...
def getArguments():
    ...
    parser.add_argument("--yourvectors", dest="yourvectors", action="store_true",
...
def getRegularizationValues():
    ...
    ### YOUR CODE HERE
    values=[0.1,0.15,0.2,0.25,0.3,0.5,0.7,0.9,1.0,2.0,3.0,4.0]
    ### END YOUR CODE
...
def main(args):
    ...
    if args.yourvectors:
        _, wordVectors = load_saved_params()
